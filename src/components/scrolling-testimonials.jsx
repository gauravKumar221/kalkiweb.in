...
const TestimonialItem = ({ testimonial, index }) => {
    ...
    return (<motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }}>
...
export default function ScrollingTestimonials() {
    return (<section className="py-16 md:py-24">
      {testimonials.map((testimonial, index) => (<TestimonialItem key={index} testimonial={testimonial} index={index}/>))}
    </section>);
}
