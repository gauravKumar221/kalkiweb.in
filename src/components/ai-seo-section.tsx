...
const features = [
  {
    ...
    description:
      "Our clients experience significant growth in organic traffic through AI-structured content and summary-optimized keyword strategies.",
  },
  {
    icon: <CheckCircle className="h-8 w-8 text-primary" />,
    title: "Expert-Led Implementation",
    description:
      "100% of our AI SEO solutions are delivered by in-house specialists, ensuring precision, consistency, and real results.",
  },
  {
    icon: <Rocket className="h-8 w-8 text-primary" />,
    title: "Advanced AI Tooling",
    description:
      "We leverage premium technical SEO audit tools, proprietary AI prompt frameworks, and advanced LLM-ranking methodologies to give you an edge.",
  },
];
    ...
    <section className="py-16 md:py-24 bg-card">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <video
              src="/images videos/JESE_YEH_VEDIO_BNANI_HAI_HIGH_gwr_video_mvp.mp4"
              autoPlay
              loop
              muted
              playsInline
