            ...
            <div>
              ...
              <form className="flex">
                <input
                  ...
                  className="bg-transparent border-b border-gray-400 w-full focus:outline-none focus:border-primary"
                />
      ...
      <div className="w-full max-w-7xl flex h-20 items-center justify-between text-white bg-black/20 backdrop-blur-md rounded-full px-4 md:px-8">
        <div className="flex-1 flex justify-start">
          ...
          >
            ...
            <span
              className={cn(
                "font-medium text-sm tracking-wider uppercase hidden md:inline",
                open && "text-black",
              )}
            >
              Menu
