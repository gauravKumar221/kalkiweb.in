...
const marketingServices = [
  {
    ...
    category: "Top-Rated SEO Company",
    description:
      "As a top-rated & most trusted SEO company in India, we deliver sustainable organic growth, page 1 rankings, and brand authority.",
    details: [
      "Top-Rated & Most Trusted SEO Company in India",
      "Professional SEO Services & Strategic Content",
      "SEO Services for Small Business & Enterprise",
      "High-Authority Link Building & Technical Audits",
    ],
  ...
  },
  {
    ...
    description:
      "Premier Google Ads agency in India designing hyper-targeted PPC management services that turn clicks into high-margin revenue.",
    details: [
      "PPC Management Services & Performance Media",
      "Google Ads Agency India (Search, Shopping, PMax)",
      "High-Intent Lead Generation Agency Funnels",
      "Data-Driven ROAS Optimization & Retargeting",
    ],
  ...
  },
  {
    ...
    category: "High-Intent Pipelines",
    description:
      "Build a predictable, automated inbound engine of qualified B2B & B2C buyers with affordable digital marketing services.",
    details: [
      "Digital Marketing Services for Business Growth",
      "High-Converting Landing Pages & Opt-In Funnels",
      "Affordable Digital Marketing Services for SMBs",
      "Automated Multi-Touch CRM Lead Nurturing",
    ],
  ...
  },
  {
    ...
    category: "Digital Branding Agency",
    description:
      "Leading social media marketing agency driving brand affinity, viral community engagement, and multi-channel customer acquisition.",
    details: [
      "Social Media Marketing Services (Meta, LinkedIn, X)",
      "Digital Branding Agency Identity & Visual Design",
      "Influencer Partnerships & Whitelisted Ads",
      "Omnichannel Social Selling & Conversion Hooks",
    ],
  ...
  },
  {
    ...
    category: "Online Marketing Agency",
    description:
      "Full-funnel performance marketing agency focused on unit economics, customer acquisition cost reduction, and scalable ROAS.",
    details: [
      "Full-Funnel Online Marketing Agency Strategies",
      "Conversion Rate Optimization (CRO) & Testing",
      "Multi-Touch First-Party Attribution Modeling",
  ...
  },
  {
    ...
    category: "Hire Digital Marketing Agency",
    description:
      "Hire digital marketing agency specialists to produce authoritative SEO-driven content that generative AI search engines cite and trust.",
    details: [
      "Digital Marketing Company India Content Clusters",
      "Authority Building & Thought Leadership Articles",
      "AEO & Generative Engine Optimization (GEO)",
      "Multi-Platform Distribution & Syndication",
    ],
...
const webDevServices = [
  {
    ...
    category: "Web Development Agency India",
    description:
      "Recognized website development company in India crafting blazing-fast Next.js web applications, headless architectures, and enterprise platforms.",
    details: [
      "Web Development Agency India (Next.js & React)",
      "Website Development Services India with Clean Code",
      "Dynamic Schema & Headless CMS (Strapi, Sanity)",
      "Role-Based Security & Production-Ready Scalability",
    ],
  ...
  },
  {
    ...
    category: "Online Stores & Multi-Vendor",
    description:
      "Enterprise e-commerce website development engineered for frictionless user checkout, global payment gateways, and high conversion velocity.",
    details: [
      "Custom E-commerce Store Architecture & Checkout",
      "Multi-Currency Payment Gateways (Razorpay, Stripe)",
      "Real-Time Inventory, Logistics & ERP Integrations",
      "Mobile-First Speed Optimization (<1.2s Load Times)",
    ],
    image: "/illustrations/user_conversion.jpg",
  ...
  },
  {
    ...
    name: "Web Design Company India",
    category: "Conversion Rate Optimization",
    description:
      "Award-winning web design company in India designing psychology-driven, high-converting layouts that elevate your brand and crush competition.",
    details: [
      "Premium Web Design Company India Aesthetics",
      "Psychology-Backed CRO Wireframes & Visual Design",
      "Interactive A/B Testing & Micro-Animations",
      "Heatmap Auditing & User Behavior Tracking",
    ],
    image: "/illustrations/team_collaboration.jpg",
    link: "/services/web-development",
  },
  {
    ...
    category: "Full-Stack Custom Software",
    description:
      "Comprehensive website development services in India spanning responsive web portals, cross-platform apps, and high-load SaaS platforms.",
    details: [
      "Full-Stack Website Development Services India",
      "Cross-Platform React Native & Progressive Web Apps",
      "Secure GraphQL / REST API Backend Systems",
      "Enterprise DevOps & Zero-Downtime Deployments",
    ],
    image: "/illustrations/design_audience_steps.jpg",
  ...
  {
    icon: <ShopifyIcon />,
    name: "Shopify Development Company",
    category: "Shopify Plus Experts",
    description:
      "Top-tier Shopify development company building bespoke Liquid and Hydrogen headless stores that scale to millions in monthly GMV.",
    details: [
      "Shopify Development Company Custom Theme Builds",
      "Bespoke Shopify App & ERP Integration Protocols",
      "Frictionless Platform Migration from Magento/Woo",
      "Checkout Extensibility & High-Traffic Stability",
    ],
    image: "/illustrations/seo_search_results.jpg",
  ...
  },
  {
    ...
    category: "Enterprise CMS & WooCommerce",
    description:
      "Trusted WordPress development company delivering hardened, lightning-fast WordPress and WooCommerce solutions for modern brands.",
    details: [
      "WordPress Development Company Custom Blocks",
      "Advanced WooCommerce Architecture & Subscriptions",
      "Enterprise Security Hardening & Malware Defense",
