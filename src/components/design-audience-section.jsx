...
export default function DesignAudienceSection() {
    return (<section className="py-20 md:py-28 bg-[#24421b] text-white overflow-hidden relative">
            <div className="container px-4 md:px-8 mx-auto">
                <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                    ...
                    <div className="space-y-6 md:space-y-8">
                        ...
                        <div>
                            <Link href="/contact" className="inline-flex items-center gap-2 text-white font-black text-sm uppercase tracking-wider group transition-transform duration-300 hover:translate-x-2">
                    ...
                    <div className="relative flex justify-center">
                        <div className="relative w-full max-w-[480px] aspect-square rounded-[2rem] overflow-hidden shadow-2xl border border-white/10">
                            <Image src="/illustrations/design_audience_steps.jpg" alt="For Working Designers, Teams, and Career Starters illustration" fill sizes="(max-w-768px) 100vw, 480px" className="object-cover" priority/>
                        </div>
                    </div>
                </div>
            </div>
