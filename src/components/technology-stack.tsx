...
import { ArrowRight, Figma, Framer, GitBranch, Lightbulb, Rocket, SquareCode, TestTube, TrendingUp, Users, Wrench } from "lucide-react";
...
export default function PortfolioPage() {
    return (
        <div>
            ...
            <section id="portfolio-grid" className="py-16 md:py-32">
