...
export default function ConceptMarquee() {
  return (
    <section className="w-full bg-white py-8 md:py-12 overflow-hidden border-y border-neutral-100 flex items-center select-none">
      <Marquee speed={40} gradient={false} pauseOnHover={true}>
        {concepts.map((concept, index) => (
          <div key={index} className="flex items-center mx-8 sm:mx-16">
