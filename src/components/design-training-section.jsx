...
const courses = [
  {
    ...
    description:
      "Learn the patterns, content craft, and oversight behind great AI products in this 4-week course.",
    bg: "bg-[#7a2e37]",
  },
  {
    ...
    description:
      "Learn to prototype faster with AI. Explore leading AI tools, streamline iteration, and bring your designs to life with unprecedented speed and creativity.",
    bg: "bg-[#d67b00]",
  },
  {
    ...
    description:
      "Master the integration of AI tools within design systems, automating workflows and generating component variations at scale.",
    bg: "bg-[#1f4e43]",
  },
  {
    ...
    description:
      "Lead design teams in the age of AI. Learn to align creative vision with product execution and scale AI-native experiences.",
    bg: "bg-[#183059]",
  },
];
      ...
      <div className="container px-4 md:px-8 mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start mb-16">
          ...
          <p className="text-base md:text-lg text-neutral-800 max-w-lg leading-relaxed pt-2 md:pt-4">
            Advance your UX or product design practice with AI-powered workflows
            and specialized training that will help you drive impact and stay
        ...
        <div className="relative w-full">
          ...
          >
            {courses.map((course, index) => (
              ...
              >
                <div
                  className={`${course.bg} rounded-[2rem] p-8 md:p-12 text-white h-[420px] md:h-[450px] flex flex-col justify-between `}
                >
                  <div>
