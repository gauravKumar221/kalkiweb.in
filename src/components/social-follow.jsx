import { Youtube, Facebook, Linkedin, Twitter } from "lucide-react";
import Link from "next/link";
import React from "react";
import Image from "next/image";
const AtSignIcon = (props) => (<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function SocialFollow() {
    return (<section className="bg-black text-white py-10 md:py-16 relative overflow-hidden">
      <Image src="https://res.cloudinary.com/dkornxvni/image/upload/v1764761624/testimonial-bg-shape_ko6lbb.webp" alt="Rotating decorative shape" width={500} height={500} className="absolute -left-48 -top-24 opacity-20 animate-slow-spin"/>
      <div className="container relative z-10">
        ...
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 justify-center">
          {socialLinks.map((item, index) => (<Link href={item.href} key={index} className="group relative w-40 h-24 sm:w-48 sm:h-28 block mx-auto">
