          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl font-bold tracking-tighter text-primary sm:text-5xl md:text-6xl">
                Seamless DevOps Services
              </h1>
              <p className="text-lg text-muted-foreground md:text-xl">
                We provide end-to-end DevOps solutions to streamline your development lifecycle, from integration and testing to deployment and monitoring.
              </p>
              <Button asChild size="lg" variant="glitch">
                <Link href="/contact">Optimize Your Workflow</Link>
              </Button>
            </div>
            <div>
              <Image
                src="https://picsum.photos/600/500"
                data-ai-hint="devops pipeline"
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground md:text-xl">
              Our DevOps experts help you build, test, and release software faster and more reliably.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div key={index} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      We implement best practices to ensure your infrastructure is scalable, resilient, and secure.
                    </p>
                  </div>
                </div>
              ))}
