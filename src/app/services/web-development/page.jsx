...
import { ShieldCheck, Zap, DatabaseBackup, Wrench, ChevronDown } from "lucide-react";
               ...
               <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <Accordion type="single" defaultValue="item-2" collapsible className="w-full">
                            {whyChooseUsData.map((item) => (<AccordionItem key={item.value} value={item.value} className="border-b-0 mb-2">
                    ...
                    <div className="flex justify-center">
                        <ShowcaseImageSlider slides={webDevShowcaseSlides} />
                    </div>
               </div>
            </div>
          </div>
      ...
      <IndustriesSection />
        ...
        <section className="py-16 md:py-24 bg-background">
            <div className="container">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <Image src="https://picsum.photos/600/700" data-ai-hint="server maintenance" alt="Web maintenance and support" width={600} height={700} className="rounded-lg object-cover"/>
                    </div>
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            {maintenanceFeatures.map((feature, index) => (<div key={index} className="flex items-start gap-4">
                                    {feature.icon}
                                    <div>
