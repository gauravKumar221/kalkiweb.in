        ...
        <div className="container py-16 md:py-24">
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
                    ...
                    <div>
                        <Image
                            ...
                            alt="Kalki Web Team"
                            data-ai-hint="team photo luxury"
                            width={800}
                            height={600}
            ...
            <section className="mb-16 md:mb-24 space-y-16">
                ...
                {ourValues.map((value, index) => (
                     <div key={index} className={`grid md:grid-cols-2 gap-8 md:gap-16 items-center ${index % 2 !== 0 ? 'md:grid-flow-row-dense' : ''}`}>
            ...
            <section id="job-openings" className="mb-16 md:mb-24">
                 ...
                 <div className="border-t border-border">
                    {jobOpenings.map((job, index) => (
                        <Link href="#apply-now" key={index} className="group block border-b border-border py-6 transition-colors duration-300 hover:bg-muted">
