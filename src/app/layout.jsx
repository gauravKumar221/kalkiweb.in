...
export default function RootLayout({ children, }) {
    return (<html lang="en" className="dark">
      <body className={cn("min-h-screen bg-background font-sans antialiased", inter.variable, kalam.variable, notoDevanagari.variable, notoBengali.variable, notoGurmukhi.variable, notoJP.variable, notoSC.variable)}>
