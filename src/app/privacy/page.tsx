  ...
  return (
    <div className="container py-16 md:py-32">
      <div className="prose prose-invert mx-auto max-w-4xl">
        ...
        <p>Kalki Web ("us", "we", or "our") operates the Kalki Web website (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>
        ...
        <p>Kalki Web uses the collected data for various purposes:</p>
        <ul>
        ...
        <ul>
          <li>By email: kalkiweb06@gmail.com</li>
