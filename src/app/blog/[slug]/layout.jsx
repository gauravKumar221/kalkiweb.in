...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    return {
      ...
      keywords: post.tags || [],
      alternates: {
        canonical: `https://www.kalkiweb.in/blog/${post.slug}`,
      },
      openGraph: {
        title: resolvedTitle,
        description: resolvedDesc,
        url: `https://www.kalkiweb.in/blog/${post.slug}`,
        siteName: "Kalki Web",
        locale: "en_IN",
        type: "article",
...
export default async function BlogPostLayout({ children, params }) {
  ...
  const jsonLd = post
    ? {
        ...
        mainEntityOfPage: {
          "@type": "WebPage",
          "@id": `https://www.kalkiweb.in/blog/${post.slug}`,
        },
      }
    : null;
